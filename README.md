...
| `brake_stack_pinn_param.py` | Parametric PINN over 5 physical parameters |
...
| | |
|---|---|
| ![Geometry](docs/btem-stack.png) | ![2D field](docs/btem-2d.png) |
| ![Day](docs/btem-day.png) | ![Inverse](docs/btem-inverse.png) |
